...
xLS = G\b;
PD_param.n=n;PD_param.p=p_var;PD_param.K=K;
[matP,matD] = constructPD(PD_param);
...
ALG_PARAMETER.formulation = formulation;

% algorithm selection
switch qnorm
    case 'cvx'
        fitmodel = @(a1,a2) spectral_ADMM_optimizedPD(G, b,a1,a2,struct_L,ALG_PARAMETER);
    case 'ncvx'
        fitmodel = @(a1,a2) adaptive_ADMM_optimizedPD(G, b,a1,a2,struct_L,ALG_PARAMETER);
end
