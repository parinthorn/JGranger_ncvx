function [x,L1x,L2x, history] = adaptive_ADMM_optimizedPD (G, b,a1,a2,struct_L,ALG_PARAMETER)
% This function solve the problem 
% min_x (1/2)||Gx-b||_2^2 + a1||L_1x||_{2,0.5} + a2||L_2x||_{2,0.5}
...
% It is the same with adaptive_ADMM.m but optimized for Px, Dx computation
% However, somehow MATLAB's routime for computing Px, Dx is faster.
