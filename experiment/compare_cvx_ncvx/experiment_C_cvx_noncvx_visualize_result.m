...
path_to_ALL_RESULT = {[resultpath,'T150_CGN_CVX_ALL_RESULT_K',int2str(K)], ...
    [resultpath,'T150_CGN_ALL_RESULT_K',int2str(K)]};
path_to_index = {[resultpath,'T150_CGN_CVX_result_K',int2str(K)], ...
    [resultpath,'T150_CGN_result_K',int2str(K)]};
