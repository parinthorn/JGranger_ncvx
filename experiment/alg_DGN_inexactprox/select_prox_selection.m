function [x,obj_prox] = select_prox_selection(z,a1,a2,qq,selection_type)
...
switch selection_type
    case 'forward' % begin with null model
        ...
        [x,prox_obj] = fix_point_prox(z,nz_ind,a1,a2,qq);
        obj_prox = prox_obj;
        
    case 'backward'
        
        [~,prox_obj,~] = fix_point_prox(z,1:K,a1,a2,qq);
        reference_loss =prox_obj;
        sol_found = 1;
        z_ind = [];
        nz_ind = 1:K;
        while sol_found
    ...
    case 'optimal'
        ...
        obj_prox = prox_obj;
    case 'greedy'
        [x_greedy,prox_obj] = fix_point_prox(z,1:1:K,a1,a2,qq);
        obj_prox =prox_obj;
        ...
        if zero_loss<prox_obj_fun(h)
            ...
            [x,prox_obj] = fix_point_prox(z,setdiff(1:K,z_ind),a1,a2,qq);
            obj_prox = prox_obj;
        end
