...
load([resultpath,'adaptive_formulation_C_cvx_result'])
load([resultpath,'adaptive_formulation_C_cvx_ALL_RESULT'])
...
%%
save([resultpath,'adaptive_formulation_C_cvx_result'],'R')
save([resultpath,'adaptive_formulation_C_cvx_ALL_RESULT'],'ALL_RESULT')