...
load('G:\My Drive\0FROM_SHARED_DRIVE\THESIS\formulation_D_result\best_index_K50.mat','best_index')
mname = {'1','5'};
dd = length(mname);
dd=1;
% dd=2;
...
save([resultpath,'optimal_formulation_D_result_regrid_K50','all'],'R')