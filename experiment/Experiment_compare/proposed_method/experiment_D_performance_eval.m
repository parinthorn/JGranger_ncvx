...
%     end
% end
% save([performance_path,'fixdf_adaptive_formulation_D_result_K',int2str(K)],'R')
% save([performance_path,'fixdf_adaptive_formulation_D_ALL_RESULT_K',int2str(K)],'ALL_RESULT')
