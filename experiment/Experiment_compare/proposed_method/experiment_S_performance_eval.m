...
for ii=1:dd
    for jj=1:realization
        fprintf('(%d,%d)\n',ii,jj)
        GTmodel = E{3,3,ii,jj};
        fname = [resultpath,'LLHcorrected_result_adaptive_formulationS_',mname{ii},'percent_lag1_K5_',int2str(jj)];
        load(fname)
...
save([performance_path,'LLHcorrected_adaptive_formulation_S_result_K5'],'R')
save([performance_path,'LLHcorrected_adaptive_formulation_S_ALL_RESULT_K5'],'ALL_RESULT')
