...
Pred.Err.Univar.ARIMA <- rep(0,rep)
...
Real.Data.Univar.ARIMA <- Real.Data.Univariate.ARIMA()
...
Pred.Err.Univar.ARIMA <- Real.Data.Univar.ARIMA$Pred.Err
...
print("MSFE for Univariate ARIMA:")
print(Pred.Err.Univar.ARIMA)
print(mean(Pred.Err.Univar.ARIMA))
print(sd(Pred.Err.Univar.ARIMA))
