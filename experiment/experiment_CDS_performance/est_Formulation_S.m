function M = est_Formulation_S(y,A_true,P,DP)
...
for ii=1:GridSize
    ...
    parfor jj=1:GridSize
        ...
        [x0,~,~, ~] = spectral_ADMM_S(gc, yc, P,DP,Lambda(ii), Lambda(jj),2,1, [n,p,K], 1,0.6,2,xLS);
        [x_est,~,~, history] = spectral_ADMM_S(gc, yc, P,DP,Lambda(ii), Lambda(jj),2,0.5, [n,p,K], 1,0.1,200,x0);
